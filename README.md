...
|-----------------------------------------------|----------------------------|
| Configuring VM's and network devices, Configuring SIEM tools for log collection, monitoring and threat hunting | <a href="https://github.com/Damms/CyberSecurityHomeLab">Cybersecurity Home Lab</a>|
